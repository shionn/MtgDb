...
public interface ImporterDao {
	...
	@Insert("INSERT INTO edition (code, magic_cards_info_code, name, release_date, mkm_name, mkm_id, online_only) "
			...
			+ "name = #{name}, mkm_name = #{mkm_name}, mkm_id = #{mkm_id}, online_only = #{onlineOnly} ")
	int edition(Set set);
